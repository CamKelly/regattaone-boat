 ...
 * Notecard JSON write 0xFEF7; Notecard response notify 0xFEF8 (legacy, CONFIG_REGATTAONE_NOTECARD_ENABLE);
 * LoRa TX write 0xFEF7 / LoRa RX notify 0xFEF8 (SX1262, replaces Notecard when disabled);
