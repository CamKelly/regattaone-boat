...
export const firebaseConfig: FirebaseConfig = {  apiKey: "AIzaSyC2dxy3_WOVllYDrYDagviDqgrOGkFBigM",
...
// Use production Firebase when running `ng serve` so Notehub-synced devices are visible.
